    ...
    return(
        <div>
            ...
            <div>
                ...
                <input type='password' name='password_check' value={password_check} onChange={onChangePassword_check} />
            </div>
            <div>
                <label htmlFor='identify_code'>identify_code : </label>
                <input type='text' name='identify_code' value={identify_code} onChange={onChangeIdentify_code} />
            </div>
            <div>
            ...
            <div>
                ...
                <input type='date' name='birthday' value={birthday} onChange={onChangeBirthday} />
            </div>
        </div>
